...
namespace MovieListWebAPI.UnitTests
{
    public class MovieListTests
    {
        ...
        public MovieListTests ()
        {
            ...
            _movieList.CreateTitle(new Title { Id = 1, Name = "A", Rating = 10 });
        }

        [Fact]
        public void CreateTitleWorksCorrectly ()
        {
            _movieList.CreateTitle(new Title { Id = _movieList.NextId, Name = "B", Rating = 9 });
        ...
        [Fact]
        public void GetTitleWorksCorrectly()
        {
            var title = _movieList.GetTitle(1);

            Assert.Equal(_movieList.Titles[0], title);
        }
        ...
        {
            _movieList.CreateTitle(new Title { Id = _movieList.NextId, Name = "B", Rating = 9 });
            _movieList.CreateTitle(new Title { Id = _movieList.NextId, Name = "C", Rating = 8 });
